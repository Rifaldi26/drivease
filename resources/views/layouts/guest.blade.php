...
<head>
    ...
    <title>@yield('title', 'DriveEase')</title>
...
<body class="min-h-screen bg-[#f4f6fb] font-inter antialiased">
    ...
    {{-- Minimal Header --}}
    <header class="border-b border-[#e5e9f2] bg-white px-4 py-4">
    ...
    <main class="flex min-h-[calc(100vh-65px)] items-center justify-center px-4 py-10">
        @yield('content')
    </main>
